    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pending_phone', models.CharField(blank=True, max_length=50, null=True, verbose_name='Телефон (в процессе замены)')),
                ('sms_code', models.CharField(blank=True, max_length=6, null=True, verbose_name='Код подтверждения')),
                ('sms_code_expiration_date', models.DateTimeField(blank=True, null=True, verbose_name='Дата и время срока годности кода подтверждения')),
